...
const TrendingCryptoTraderSection = ({ className }: IProp) => {
  ...
  return (
    ...
    >
      <header className='flex items-center gap-5'>
        ...
        <h2 className='text-su_primary text-2xl font-semibold'>Trending Crypto Traders</h2>
      </header>
...
export default TrendingCryptoTraderSection;